export default function Footer() {
  return (
    <div className="w-full mt-1 pb-4 px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-64">
      ...
      <footer className="footer flex flex-col sm:flex-row justify-between gap-4 text-neutral-content items-center mt-auto">
        <aside className="text-center sm:text-left text-sm sm:text-base">
