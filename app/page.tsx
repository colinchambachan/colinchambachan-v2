    ...
    <div className="w-full h-full px-4 sm:px-6 md:px-8">
      <div className="hero max-w-5xl mx-auto">
        <div className="flex flex-col items-center md:flex-row md:items-start md:justify-between">
          <Image
            src={hero}
            className="w-40 h-40 sm:w-52 sm:h-52 md:w-64 md:h-64 xl:w-80 xl:h-80 rounded-full shadow-2xl mb-6 md:mb-0 object-cover"
          ...
          />
          <div
            className="text-center md:text-left md:ml-8 md:max-w-lg"
            data-aos="fade-up"
          >
            <h1 className="text-4xl sm:text-5xl font-bold">Hi, I'm Colin</h1>
            ...
            <div className="flex justify-center md:justify-start gap-4 py-6 md:hidden">
              <a
